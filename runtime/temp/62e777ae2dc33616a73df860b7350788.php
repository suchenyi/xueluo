<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"/www/xueluo/Public/../application/admin/view/post/list.html";i:1505197779;s:63:"/www/xueluo/Public/../application/admin/view/Public/header.html";i:1504864343;s:61:"/www/xueluo/Public/../application/admin/view/Public/left.html";i:1505118176;s:63:"/www/xueluo/Public/../application/admin/view/Public/footer.html";i:1504858368;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo !empty($v['status'])?'<span class="label label-success">展示</span>' : '<span class="label label-danger">不展示</span>'; ?></td>
                                <td>
                                    <a class="btn btn-info btn-sm" href="/admin/post_add/<?php echo $v['id']; ?>">查看</a>
