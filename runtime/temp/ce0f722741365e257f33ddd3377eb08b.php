<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:59:"/www/xueluo/Public/../application/admin/view/user/list.html";i:1504864375;s:63:"/www/xueluo/Public/../application/admin/view/Public/header.html";i:1504864343;s:61:"/www/xueluo/Public/../application/admin/view/Public/left.html";i:1505118176;s:63:"/www/xueluo/Public/../application/admin/view/Public/footer.html";i:1504858368;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td><?php echo !empty($user['status'])?'<span class="label label-success">启用</span>' : '<span class="label label-danger">禁用</span>'; ?></td>
                                <td>
                                    <button class="btn btn-info btn-sm">查看</button>
                                    <?php echo !empty($user['status']) && $user['status']==1?'<button class="btn btn-warning btn-sm">禁用</button>':'<button class="btn btn-danger btn-sm">启用</button>'; ?>
                                </td>
                            </tr>
