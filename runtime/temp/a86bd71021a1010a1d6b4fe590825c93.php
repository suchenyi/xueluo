<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"/www/xueluo/Public/../application/admin/view/index/index.html";i:1505116248;s:63:"/www/xueluo/Public/../application/admin/view/Public/header.html";i:1504864343;s:61:"/www/xueluo/Public/../application/admin/view/Public/left.html";i:1505118176;s:63:"/www/xueluo/Public/../application/admin/view/Public/footer.html";i:1504858368;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
        <meta charset="UTF-8">
    ...
    <section class="content invoice">
        ...
        <div class="callout callout-info">
            <h4>Hi,Welcome admins</h4>
            <p>This is my blog home page.</p>
        </div>
        <!--<div class="row">-->
            <!--<div class="col-xs-12">-->
            ...
            <div class="col-xs-6">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tr>
                            <th>浏览器</th>
                            <td><?php echo $sys_info['browser']; ?></td>
                        </tr>
                        <tr>

                            <th>日期</th>
                            <td><?php echo $sys_info['date']; ?></td>
                        </tr>
                        </tbody></table>
                </div>
            </div><!-- /.col -->
