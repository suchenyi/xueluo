<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:64:"/www/xueluo/Public/../application/admin/view/sort/sort_list.html";i:1505181928;s:63:"/www/xueluo/Public/../application/admin/view/Public/header.html";i:1504864343;s:61:"/www/xueluo/Public/../application/admin/view/Public/left.html";i:1505118176;s:63:"/www/xueluo/Public/../application/admin/view/Public/footer.html";i:1504858368;}*/ ?>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($list as $k => $vo): ?>
                            <tr>
                                ...
                                <td><?php echo !empty($vo['status']) && $vo['status']==1?'<span class="label label-success">启用</span>' : '<span class="label label-danger">禁用</span>'; ?></td>
                                <td>
                                    <a class="btn btn-success btn-sm">修改</a>
                                    <?php echo !empty($vo['status']) && $vo['status']==1?'<button class="btn btn-warning btn-sm">禁用</button>':'<button class="btn btn-danger btn-sm">启用</button>'; ?>
                                </td>
                            </tr>

                        <?php foreach ($vo['arr'] as $key => $v): ?>
                        <tr>
                            <td><?php echo $v['id']; ?></td>
                            <td>&nbsp;&nbsp;&nbsp;&nbsp;|--- <?php echo $v['name']; ?></td>
                            <td><?php echo date("Y-m-d H:i:s",$v['create_time']); ?></td>
                            <td><?php echo !empty($v['status']) && $v['status']==1?'<span class="label label-success">启用</span>' : '<span class="label label-danger">禁用</span>'; ?></td>
                            <td>
                                <a class="btn btn-success btn-sm">修改</a>
                                <?php echo !empty($v['status']) && $v['status']==1?'<button class="btn btn-warning btn-sm">禁用</button>':'<button class="btn btn-danger btn-sm">启用</button>'; ?>
